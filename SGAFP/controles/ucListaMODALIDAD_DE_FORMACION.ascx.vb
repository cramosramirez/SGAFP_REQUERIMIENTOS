...
#Region"Propiedades"
    ...
    Public Property HeaderMODALIDAD_FORMACION() As String
        Get
...
#End Region
    ...
    Public Function CargarDatos() As Integer
        Dim lMODALIDAD_DE_FORMACION As listaMODALIDAD_DE_FORMACION
        lMODALIDAD_DE_FORMACION = Me.mComponente.ObtenerLista()
        If lMODALIDAD_DE_FORMACION is Nothing Then
            Me.gvLista.Visible = False
            Return -1
        End If
        Me.gvLista.SelectedIndex = -1
        Me.gvLista.Visible = True
        Me.gvLista.DataSource = lMODALIDAD_DE_FORMACION
        Me.gvLista.DataBind()
        Return 1
    End Function
    ...
    Protected Sub gvLista_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvLista.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim mLabelID_MODALIDAD_FORMACION As Label
            mLabelID_MODALIDAD_FORMACION = e.Row.FindControl("Label_ID_MODALIDAD_FORMACION")
            mLabelID_MODALIDAD_FORMACION.Visible = Not Me.PermitirEditar
    ...
    Private Sub gvLista_RowDeleting(ByVal source As System.Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvLista.RowDeleting
        If Me.mComponente.EliminarMODALIDAD_DE_FORMACION(CDec(CType(Me.gvLista.Rows(e.RowIndex).FindControl("LinkButton1"), LinkButton).ToolTip)) <> 1 Then
    ...
    Public Function DevolverSeleccionados() As listaMODALIDAD_DE_FORMACION
        Dim mLista As New listaMODALIDAD_DE_FORMACION
        For Each mRow As GridViewRow In Me.gvLista.Rows
            If CType(mRow.FindControl("CheckBox_Seleccionar"), CheckBox).Checked Then
                ...
                mEntidad.ID_MODALIDAD_FORMACION = CInt(CType(mRow.FindControl("Label_ID_MODALIDAD_FORMACION"), Label).Text)
                mLista.Add(mEntidad)
            End If
        Next
        Return mLista
